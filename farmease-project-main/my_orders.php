...
$sql = "SELECT orders.id, user.user_first_name, user.user_last_name, 
               ...
               orders.address, orders.pin, products.phone_number, orders.purchase_date, orders.status 
        FROM orders 
        ...
        <tr>
            ...
            <td>
                <form method="POST">
                    ...
                    <select name="status">
                    <option value="Not Delivered" <?php if ($row['status'] == 'Not Delivered') echo "selected"; ?>>Not Delivered</option>
